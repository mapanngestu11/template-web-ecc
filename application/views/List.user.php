            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data User /</span> Tabel User</h4>
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive text-nowrap">
                                <button type="button" class="btn btn-primary btn-tambah" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    <i class="menu-icon tf-icons bx bx-plus"></i> Tambah Data User
                                </button>
                                <br>
                                <br>
                                <!-- Modal -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a class="btn btn-link btn-primary btn-lg" style="color: white;" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $id; ?>"><i class="menu-icon tf-icons bx bx-pencil"></i></a>
