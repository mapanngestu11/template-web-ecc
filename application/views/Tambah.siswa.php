...
<head>
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            <div class="card mb-4">
              <h5 class="card-header">Formulir Tambah Data Siswa</h5>
              <!-- Account -->
              <div class="card-body">
                <form id="formAccountSettings" action="<?php echo base_url() . 'Siswa/add'; ?>" method="POST" enctype="multipart/form-data" autocomplete="on">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3 col-md-6">
                   ...
                   <input type="number" class="form-control" name="no_hp" placeholder="0838xxxx" required>
                 </div>
               </div>
               <div class="row">
  ...
  <div class="row">
    ...
    <div class="mb-3 col-md-6">
      <br>
      <input type="checkbox" name="validasi_data" value="sudah" required/>
      <label for="vehicle1"> Saya Telah Menyetujui <a type="button" class="syarat" data-bs-toggle="modal" data-bs-target="#exampleModal">persayatan</a> untuk pendaftaran.</label><br>
    </div> 
  </div>
